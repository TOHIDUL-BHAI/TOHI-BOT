...
try{
   ...
   if (found) {
      ...
      if (!arr) {
        ...
        const randomReplies = [
          "Yes 😀, Bolo Bbz💋",
          "Jamai Ki Cheka Dise 🥸 Je Amake Dako",
          "Bolo cutee pieb😻",
          "amake na deke amar boss tohidul er in jaw m.me/mdtohidulislam063 ",
          "Rejected 😏😎",
          "kawre patta dimu na karon fair and Lively kinchi😎😏",
          "Tumi to sei pagol ta na 🤔",
          "Besi dakle leave nimu ☹",
          "Sunmu na tmi amak frem korai daw nai 🫤",
          "👀 oi tmi na tohidul boss er bow 🌚"
        ];
